...
const styles = StyleSheet.create({
  ...
  primaryBtn: { height: 48, backgroundColor: '#8b5cf6', borderRadius: 12, alignItems: 'center', justifyContent: 'center', marginTop: 8 },
  primaryBtnText: { color: '#fff', fontSize: 16, fontWeight: '600' },
  outlineBtn: { flex: 1, height: 48, borderWidth: 2, borderColor: '#8b5cf6', borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
